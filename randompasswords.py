...
labelLenghtPassw = tk.Label(text="Enter lenght of password", font=("Montserrat", 15), master=frameDown) #lenght of password
labelOldPass = tk.Label(text="Genereted passwords", font=("Montserrat", 15), master=frameGeneral)
password_lenght = tk.Entry(font=("Montserrat"), master=frameDown) #entry for lenght of password
